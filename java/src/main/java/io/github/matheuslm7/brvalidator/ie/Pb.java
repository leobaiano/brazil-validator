...
/**
 * PB: verified against the official SEFAZ-PB "Roteiro de Crítica da Inscrição Estadual"
 * (sintegra.gov.br/Cad_Estados/cad_PB.html), including its worked example (06000001-5). Format:

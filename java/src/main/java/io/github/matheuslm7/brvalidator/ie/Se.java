...
/**
 * SE: verified against the official SEFAZ-SE "Roteiro de Crítica da Inscrição Estadual"
 * (sintegra.gov.br/Cad_Estados/cad_SE.html), including its worked example (27123456-3). Format:

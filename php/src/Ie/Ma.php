...
/**
 * Verified against the official SEFAZ-MA "Roteiro de Critica da Inscricao
 * Estadual" (sintegra.gov.br/Cad_Estados/cad_MA.html), including its
 * worked example (120000385). Format: "12" (fixed) + 6 sequence digits +
 * 1 check digit = 9 digits total. No official punctuation mask is
 * published, so format() returns plain digits.
 *

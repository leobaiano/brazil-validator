...
/**
 * Verified against the official SEFAZ-SE "Roteiro de Critica da Inscricao
 * Estadual" (sintegra.gov.br/Cad_Estados/cad_SE.html), including its
 * worked example (27123456-3). Format: 8 digits + 1 check digit.
 *

...
/**
 * Verified against the official SEFAZ-PB "Roteiro de Critica da Inscricao
 * Estadual" (sintegra.gov.br/Cad_Estados/cad_PB.html), including its
 * worked example (06000001-5). Format: 8 digits + 1 check digit.
 *

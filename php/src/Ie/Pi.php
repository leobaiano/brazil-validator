...
/**
 * Verified against the official SEFAZ-PI "Roteiro de Critica da Inscricao
 * Estadual" (sintegra.gov.br/Cad_Estados/cad_PI.html), including its
 * worked example (012345679). Format: 8 digits + 1 check digit.
 *
